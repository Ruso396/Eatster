...
const AdminOffers = () => {
  ...
  const [refresh, setRefresh] = useState(false);
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/api/restaurants/${restaurantId}/banners`).then(res => setBanners(res.data));
    ...
    const handleDeleteBanner = async (bannerId) => {
        ...
        await axios.delete(`http://localhost:5000/api/restaurants/banners/${bannerId}`);
    ...
    const handleEditBannerSubmit = async (e) => {
        ...
        await axios.put(`http://localhost:5000/api/restaurants/banners/${editBannerId}`, data);
  ...
  const handleSubmit = async (e) => {
    ...
    const handleBannerUpload = async (e) => {
        ...
        try {
            ...
            await axios.post("http://localhost:5000/api/restaurants/banners", data);
            setBannerImage(null);
