...
const Settings = () => {
  ...
  const handleRestaurantDetailsSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://192.168.18.187:5000/api/restaurants/details/${userEmail}`, {
  ...
  const handleBankDetailsSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://192.168.18.187:5000/api/restaurants/bank-details/${userEmail}`, {
