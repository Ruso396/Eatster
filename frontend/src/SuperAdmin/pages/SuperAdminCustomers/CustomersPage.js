...
const CustomersPage = ({ themeColor, isDarkMode }) => {
  ...
  const loadUsers = async () => {
    ...
    try {
      ...
      const customerRes = await axios.get('https://backend-weld-three-46.vercel.app/api/users');
      ...
      const restaurantRes = await axios.get('https://backend-weld-three-46.vercel.app/api/restaurants');
