...
const CustomersPage = ({ themeColor, isDarkMode }) => {
  ...
  const loadUsers = async () => {
    ...
    try {
      ...
      const customerRes = await axios.get('https://eatster-nine.vercel.app/api/users');
      ...
      const restaurantRes = await axios.get('https://eatster-nine.vercel.app/api/restaurants');
